---
name: knowledge-base:resolve-feedback
...
# knowledge-base:resolve-feedback
...
- The user explicitly invokes `/knowledge-base-resolve-feedback`
...
2. If empty → tell the user: "No committed reviews found. Open a review session first via `/knowledge-base-review`."
